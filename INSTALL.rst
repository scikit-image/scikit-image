...
.. code-block:: sh
  ...
  # Install major development and runtime dependencies of scikit-image from conda-forge
  conda install -c conda-forge `for i in requirements/{default,build,test}.txt; do echo -n " --file $i "; done`
