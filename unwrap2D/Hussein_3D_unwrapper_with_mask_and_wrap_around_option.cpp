...
{
	printf("Reading the mask from Binary File.............>");
	FILE *ifptr;
	ifptr = fopen(inputfile,"rb");
	if(ifptr == NULL) printf("Error opening the file\n");
...
void extend_mask(unsigned char *input_mask, unsigned char *extended_mask, int volume_width, int volume_height, int volume_depth)
{
	...
	if (x_connectivity == 1)
	{
		...
		for (n=1; n < volume_depth - 1; n++)
		{
			for (i=1; i < volume_height - 1; i++)
			{
				if( (*IMP) == 255						&& (*(IMP + vw - 1) == 255)			&& (*(IMP + 1) == 255) &&
					(*(IMP - vw) == 255)				&& (*(IMP + vw) == 255)	&& 
					(*(IMP - fs) == 255)				&& (*(IMP + fs) == 255) &&
					(*(IMP - 1) == 255)					&& (*(IMP + vw + 1) == 255) &&
					(*(IMP - vw + 1) == 255)			&& (*(IMP + 2 * vw - 1) == 255) && 
					(*(IMP - fs - 1) == 255)			&& (*(IMP + fs + vw + 1) == 255) && 
					(*(IMP - fs - vw) == 255)			&& (*(IMP + fs + vw) == 255) &&
					(*(IMP - fs - vw + 1) == 255)		&& (*(IMP + fs + 2 * vw - 1) == 255) && 
					(*(IMP - fs + vw - 1) == 255)		&& (*(IMP + fs + 1) == 255)	&& 
					(*(IMP - fs + 1) == 255)			&& (*(IMP + fs + vw - 1) == 255) &&
					(*(IMP - fs + 2 * vw - 1) == 255)	&& (*(IMP + fs - vw + 1) == 255) &&
					(*(IMP - fs + vw) == 255)			&& (*(IMP + fs - vw) == 255) && 
					(*(IMP - fs + vw + 1) == 255)		&& (*(IMP + fs - 1) == 255) )
				{		
					*EMP = 255;
	...
	if (y_connectivity == 1)
	{
		...
		for (n=1; n < volume_depth - 1; n++)
		{
			...
			{
				if( (*IMP) == 255						&& (*(IMP - 1) == 255)			&& (*(IMP + 1) == 255) &&
					(*(IMP + fs - vw) == 255)			&& (*(IMP + vw) == 255)	&& 
					(*(IMP - fs) == 255)				&& (*(IMP + fs) == 255) &&
					(*(IMP + fs - vw - 1) == 255)		&& (*(IMP + vw + 1) == 255) &&
					(*(IMP + fs - vw + 1) == 255)		&& (*(IMP + vw - 1) == 255) && 
					(*(IMP - vw - 1) == 255)			&& (*(IMP + fs + vw + 1) == 255) && 
					(*(IMP - vw) == 255)				&& (*(IMP + fs + vw) == 255) &&
					(*(IMP - vw + 1) == 255)			&& (*(IMP + fs + vw - 1) == 255) && 
					(*(IMP - fs - 1) == 255)			&& (*(IMP + fs + 1) == 255)	&& 
					(*(IMP - fs + 1) == 255)			&& (*(IMP + fs - 1) == 255) &&
					(*(IMP - fs + vw - 1) == 255)		&& (*(IMP + 2 * fs - vw + 1) == 255) &&
					(*(IMP - fs + vw) == 255)			&& (*(IMP + 2 * fs - vw) == 255) && 
					(*(IMP - fs + vw + 1) == 255)		&& (*(IMP + 2 * fs - vw - 1) == 255) )
				{		
					*EMP = 255;
				}
		...
		for (n=1; n < volume_depth - 1; n++)
		{
			for (j=1; j < volume_width - 1; j++)
			{
				if( (*IMP) == 255						&& (*(IMP + 1) == 255)			&& (*(IMP - 1) == 255) &&
					...
					(*(IMP - fs - 1) == 255)			&& (*(IMP + fs + 1) == 255)	&& 
					(*(IMP - fs + 1) == 255)			&& (*(IMP + fs - 1) == 255) &&
					(*(IMP - 2 * fs + vw - 1) == 255)	&& (*(IMP + fs - vw + 1) == 255) &&
					(*(IMP - 2 * fs + vw) == 255)		&& (*(IMP + fs - vw) == 255) && 
					(*(IMP - 2 * fs + vw + 1) == 255)	&& (*(IMP + fs - vw - 1) == 255) )							
				{		
					*EMP = 255;
				}
	...
	if (z_connectivity == 1)
	{
		...
		for (i=1; i < volume_height - 1; ++i)
		{
			for (j=1; j < volume_width - 1; ++j)
			{
				if( (*IMP) == 255						&& (*(IMP - 1) == 255)			&& (*(IMP + 1) == 255) &&
					(*(IMP - vw) == 255)				&& (*(IMP + vw) == 255)	&& 
					(*(IMP + fs) == 255)				&& (*(IMP + vs  -  fs) == 255) &&
					(*(IMP - vw - 1) == 255)			&& (*(IMP + vw + 1) == 255) &&
					(*(IMP - vw + 1) == 255)			&& (*(IMP + vw - 1) == 255) && 
					(*(IMP + vs - fs - vw - 1) == 255)	&& (*(IMP + fs + vw + 1) == 255) && 
					(*(IMP + vs - fs - vw) == 255)		&& (*(IMP + fs + vw) == 255) &&
					(*(IMP + vs - fs - vw + 1) == 255)	&& (*(IMP + fs + vw - 1) == 255) && 
					(*(IMP + vs - fs - 1) == 255)		&& (*(IMP + fs + 1) == 255)	&& 
					(*(IMP + vs - fs + 1) == 255)		&& (*(IMP + fs - 1) == 255) &&
					(*(IMP + vs - fs + vw - 1) == 255)	&& (*(IMP + fs - vw + 1) == 255) &&
					(*(IMP + vs - fs + vw) == 255)		&& (*(IMP + fs - vw) == 255) && 
					(*(IMP + vs - fs + vw + 1) == 255)	&& (*(IMP + fs - vw - 1) == 255) )
		...
		for (i=1; i < volume_height - 1; ++i)
		{
			for (j=1; j < volume_width - 1; ++j)
			{
				if( (*IMP) == 255						&& (*(IMP + 1) == 255)			&& (*(IMP - 1) == 255) &&
					...
					(*(IMP - vw - 1) == 255)			&& (*(IMP + vw + 1) == 255) &&
					(*(IMP - vw + 1) == 255)			&& (*(IMP + vw - 1) == 255) && 
					(*(IMP - fs - vw - 1) == 255)		&& (*(IMP - vs + fs + vw + 1) == 255)	&& 
					(*(IMP - fs - vw + 1) == 255)		&& (*(IMP - vs + fs + vw - 1) == 255) &&
					(*(IMP - fs - vw) == 255)			&& (*(IMP - vs + fs + vw) == 255) && 
					(*(IMP - fs - 1) == 255)			&& (*(IMP - vs + fs + 1) == 255)	&& 
					(*(IMP - fs + 1) == 255)			&& (*(IMP - vs + fs - 1) == 255) &&
					(*(IMP - fs + vw - 1) == 255)		&& (*(IMP - vs + fs - vw + 1) == 255) &&
					(*(IMP - fs + vw) == 255)			&& (*(IMP - vs + fs - vw) == 255) && 
					(*(IMP - fs + vw + 1) == 255)		&& (*(IMP - vs + fs - vw - 1) == 255) )		
...
void  horizontalEDGEs(VOXELM *voxel, EDGE *edge, int volume_width, int volume_height, int volume_depth)
{
	int n, i, j;
	...
	if (x_connectivity == 1)
	{
		...
		for (n=0; n < volume_depth; n++)
		{
			for (i = 0; i < volume_height; i++)
			{
				if (voxel_pointer->input_mask == 255 && (voxel_pointer - volume_width + 1)->input_mask == 255 )
				{
					edge_pointer->pointer_1 = voxel_pointer;
...
void  verticalEDGEs(VOXELM *voxel, EDGE *edge, int volume_width, int volume_height, int volume_depth)
{
	...
	if (y_connectivity == 1)
	{
		...
		for (n=0; n < volume_depth; n++)
		{
			...
			{
				if (voxel_pointer->input_mask == 255 && (voxel_pointer - next_voxel)->input_mask == 255 )
				{
					edge_pointer->pointer_1 = voxel_pointer;
...
{  
	...
	read_data("MRI wrapped phase volume 64X64X46.dat", WrappedVolume, volume_size);
	...
	read_mask("mask3d.dat", input_mask, volume_size);
	...
	write_data("unwrapped.dat", UnwrappedVolume, volume_size);
