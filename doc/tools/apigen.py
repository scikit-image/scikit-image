...
class ApiDocWriter:
    ...
    def __init__(
        ...
        per_function_pages : bool, optional
            If True, generate one page per function/class using Sphinx
            autosummary's ``:toctree:`` option together with custom
            ``_templates/autosummary/`` templates. Each module page will
            contain only the summary table; the per-member detail pages are
            generated by autosummary at Sphinx build time. Default is False.
        """
        ...
        self.per_function_pages = per_function_pages
