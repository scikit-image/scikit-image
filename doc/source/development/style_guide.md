...
* Mandatory parameters that a function operates on or is named after can be passed as *positional or keyword* parameters.
  Use *keyword-only* parameters for the remaining ones, especially if they are optional. 
  Examples:
  ```python
...
* Refer to array dimensions as *i, j, k*, not as *x, y, z* or *(plane,) row, column*. 
