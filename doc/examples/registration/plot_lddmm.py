...
# Coordinate Framework (CCF), which is a 3D mouse brain atlas that was created by
# averaging serial two-photon tomography images of many individual mice [1]. This
# example uses the 50 micron version of the template.
#
...
# Used with permission and under the Creative Commons Attribution 4.0 International license.
#
# It was generated using the methods outlined in this paper [2].
#
# References
# ----------
