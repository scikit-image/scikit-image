...
print((f'{sig_feature_count} features, or {sig_feature_percent}%, account for 70% of branch points in the '
       f'random forest.'))
...
summary = ((f"Computing the full feature set took {time_full_feature_comp:.3f}s, plus {time_full_train:.3f}s "
            f"training, for an AUC of {auc_full_features:.2f}. Computing the restricted "
            f"feature set took {time_subs_feature_comp:.3f}s, plus {time_subs_train:.3f}s training, "
            f"for an AUC of {auc_subs_features:.2f}."))
