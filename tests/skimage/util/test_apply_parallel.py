...
from _skimage2._shared.testing import assert_array_almost_equal, assert_equal
from skimage import color, data, img_as_float
from skimage.filters import threshold_local, gaussian

# Don't use `from skimage.util.apply_parallel import apply_parallel` as this
# may bypass lazy_loader. This causes problems in
# `test_migration::test_public_skimage_api` because skimage.util.apply_parallel`
# then refers to the module instead of the function.
