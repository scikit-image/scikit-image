...
@pytest.mark.parametrize("min_sigma", [0, -1, [0, 1], [1, 0]])
def test_blob_dog_min_sigma_nonpositive_raises(min_sigma):
    # Regression test: non-positive min_sigma used to raise an unhandled
