...
from _skimage2 import color, data, img_as_float
from _skimage2.filters import threshold_local, gaussian
from _skimage2.util.apply_parallel import apply_parallel
