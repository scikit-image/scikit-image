...
def test_hough_line_peaks_single_angle():
    ...
    rng = np.random.RandomState(3663933399)
...
@run_in_parallel()
def test_hough_circle(circle_perimeter):
    # Prepare picture
...
def test_hough_circle_extended(circle_perimeter):
    # Prepare picture
...
def test_hough_circle_peaks(circle_perimeter):
...
def test_hough_circle_peaks_total_peak(circle_perimeter):
    img = np.zeros((120, 100), dtype=int)
...
def test_hough_circle_peaks_min_distance(circle_perimeter):
...
def test_hough_circle_peaks_total_peak_and_min_distance(circle_perimeter):
...
def test_hough_circle_peaks_normalize(circle_perimeter):
    x_0, y_0, rad_0 = (50, 50, 20)
    img = np.zeros((120, 100), dtype=int)
    y, x = circle_perimeter(y_0, x_0, rad_0)
    img[x, y] = 1
...
def test_hough_ellipse_zero_angle(ellipse_perimeter):
...
def test_hough_ellipse_non_zero_posangle1(ellipse_perimeter):
...
def test_hough_ellipse_non_zero_posangle2(ellipse_perimeter):
    # ry < rx, angle in [0:pi/2]
    img = np.zeros((30, 24), dtype=int)
    rx = 12
    ry = 6
...
def test_hough_ellipse_non_zero_posangle3(ellipse_perimeter):
...
def test_hough_ellipse_non_zero_posangle4(ellipse_perimeter):
...
def test_hough_ellipse_non_zero_negangle1(ellipse_perimeter):
    # ry > rx, angle in [0:-pi/2]
    img = np.zeros((30, 24), dtype=int)
    rx = 6
    ry = 12
...
def test_hough_ellipse_non_zero_negangle2(ellipse_perimeter):
    # ry < rx, angle in [0:-pi/2]
    img = np.zeros((30, 24), dtype=int)
    rx = 12
    ry = 6
...
def test_hough_ellipse_non_zero_negangle3(ellipse_perimeter):
    # ry < rx, angle in [-pi/2:-pi]
    img = np.zeros((30, 24), dtype=int)
    rx = 12
    ry = 6
...
def test_hough_ellipse_non_zero_negangle4(ellipse_perimeter):
    # ry < rx, angle in [-pi:-3pi/4]
    img = np.zeros((30, 24), dtype=int)
    rx = 12
    ry = 6
