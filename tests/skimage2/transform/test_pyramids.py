...
def test_pyramid_reduce_gray(image_gray):
...
def test_pyramid_reduce_gray_defaults(image_gray):
    rows, cols = image_gray.shape
...
def test_pyramid_expand_gray(image_gray):
    rows, cols = image_gray.shape
...
def test_build_gaussian_pyramid_gray(image_gray):
    rows, cols = image_gray.shape
...
def test_build_gaussian_pyramid_gray_defaults(image_gray):
    rows, cols = image_gray.shape
...
def test_build_laplacian_pyramid_defaults(image_gray):
    rows, cols = image_gray.shape
