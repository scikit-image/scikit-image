...
class SIFT(FeatureDetector, DescriptorExtractor):
    ...
    sigma_in : float, optional
        The assumed blur level of the input image. Must be strictly
        less than ``sigma_min / upsampling``.
    ...
    def __init__(
        ...
        if sigma_in >= self.sigma_min:
            raise ValueError("sigma_in must be less than sigma_min / upsampling")
