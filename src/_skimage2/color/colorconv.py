...
def rgb2hed(rgb, *, channel_axis=-1):
    ...
    >>> ihc = data.fetch_immunohistochemistry()
    >>> ihc_hed = rgb2hed(ihc)
    """
...
def combine_stains(stains, conv_matrix, *, channel_axis=-1):
    ...
    Parameters
    ----------
    stains : array_like of shape (..., C=3, ...)
