...
from _skimage2.filters.rank.bilateral import (
    mean_bilateral as _ski2_mean_bilateral,
    pop_bilateral as _ski2_pop_bilateral,
    sum_bilateral as _ski2_sum_bilateral,
)
