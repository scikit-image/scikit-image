...
@pytest.mark.parametrize("threshold_function, lower_Bound, upper_bound", [
...
def test_thresholds_dask_compatibility():
    ...
    assert lower_bound < float(threshold_function(dask_camera)) < upper_bound
