...
def shapecontext(image, r_min, r_max, current_pixel, radial_bins=5, polar_bins=12):
    ...
    Compute Shape Context by summing non-zero points into a log-polar histogram. All non-zero pixels of the image are considered to be in the object or shape.
