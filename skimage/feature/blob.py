...
def blob_dog(image, min_sigma=1, max_sigma=50, sigma_ratio=1.6, threshold=2.0,
    ...
    >>> feature.blob_dog(data.coins(), threshold=.5, max_sigma=40)  # doctest: +NORMALIZE_WHITESPACE
...
def blob_log(image, min_sigma=1, max_sigma=50, num_sigma=10, threshold=.2,
    ...
    >>> feature.blob_log(img, threshold = .3)  # doctest: +NORMALIZE_WHITESPACE
...
def blob_doh(image, min_sigma=1, max_sigma=30, num_sigma=10, threshold=0.01,
    ...
    >>> from skimage import data, feature
    >>> img = data.coins()
    >>> feature.blob_doh(img)  # doctest: +NORMALIZE_WHITESPACE
    array([[270.        , 363.        ,  30.        ],
           [265.        , 113.        ,  23.55555556],
           [262.        , 243.        ,  23.55555556],
           [260.        , 173.        ,  30.        ],
