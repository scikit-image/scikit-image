...
class TestCanny(unittest.TestCase):
    def test_00_00_zeros(self):
        ...
        result = feature.canny(np.zeros((20, 20)), 4,
    ...
    def test_00_01_zeros_mask(self):
        ...
        result = (feature.canny(np.random.uniform(size=(20, 20)), 4,
    ...
    def test_01_01_circle(self):
        ...
        result = feature.canny(c.astype(float), 4,
    ...
    def test_01_02_circle_with_noise(self):
        ...
        result = feature.canny(cf, 4, mask=np.ones(c.shape, bool),
                               thresholds=(.1, .2))
        #
        # erode and dilate the circle to get rings that should contain the
        # outlines
    ...
    def test_mask_none(self):
        result1 = feature.canny(np.zeros((20, 20)), 4, thresholds=(0, 0),
                                mask=np.ones((20, 20), bool))
        result2 = feature.canny(np.zeros((20, 20)), 4, thresholds=(0, 0))
