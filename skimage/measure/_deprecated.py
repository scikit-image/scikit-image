...
def label(input, neighbors=None, background=None, return_num=False,
    ...
    warn("skimage.measure.label is deprecated and will be removed "
         "in version 0.19. Please use skimage.morphology.label instead",
         FutureWarning, stacklevel=2)
    return label(input, neighbors, background, return_num, connectivity)
