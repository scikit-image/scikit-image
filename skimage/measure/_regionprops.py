...
PROPS = {
    ...
    'Image': 'image',
    'FullMask': 'full_mask',
    'BoundedMask': 'bounded_mask',
    'FilledBoundedMask': 'filled_bounded_mask',
...
def regionprops(label_image, intensity_image=None, cache=True):
    ...
    Returns
    -------
    List of :class:`RegionProperties` objects.
