...
def manders_coloc_coeff(image, mask, roi=None):
    ...
    intensity of a certain channel that is within the segmented region of a
    second channel [1]_. It ranges from 0 for no colocalisation to 1 for
    complete colocalization. It is also referred to as M1 and M2.
