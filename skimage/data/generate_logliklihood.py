...
areas_fg = [(slice(330, 350), slice(330, 350))]
...
gmm_fg = mixture.GMM(4, min_covar=1.0)
gmm_bg = mixture.GMM(8, min_covar=1.0)
...
plt.subplot(5, 2, 3)
plt.imshow(src, interpolation='nearest', cmap=jet, vmin=0, vmax=96)

plt.subplot(5, 2, 4)
plt.imshow(sink, interpolation='nearest', cmap=jet, vmin=0, vmax=96)
