...
def flood_fill(image, seed_point, new_value, *, selem=None, connectivity=None,
    ...
    return flood_fill(image, seed_point, new_value, selem=selem,
                      connectivity=connectivity, tolerance=tolerance,
                      in_place=in_place, inplace=inplace)
...
def flood(image, seed_point, *, selem=None, connectivity=None, tolerance=None):
    ...
    warn("skimage.morphology.flood is deprecated and will be removed "
         ...
         FutureWarning, stacklevel=2)
    return flood(image, seed_point, selem=selem, connectivity=connectivity,
                 tolerance=tolerance)
