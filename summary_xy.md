...
*   **`swirl`**
    ...
    *   **GitHub Link:**
        *   [Docstring for `center` parameter](https://github.com/scikit-image/skimage/blob/main/src/skimage/transform/_warps.py#L707)

*   **`rotate`**
    *   **Reasoning:** The `center` parameter is documented in terms of `(cols, rows)`, which corresponds to an `(x, y)` convention.
    *   **GitHub Link:**
        *   [Docstring for `center` parameter](https://github.com/scikit-image/skimage/blob/main/src/skimage/transform/_warps.py#L465)
...
*   **`LineModelND`**
    ...
    *   **GitHub Links:**
        *   [`predict_x` method](https://github.com/scikit-image/skimage/blob/main/src/skimage/measure/fit.py#L384)
        *   [`predict_y` method](https://github.com/scikit-image/skimage/blob/main/src/skimage/measure/fit.py#L415)
...
*   **`CircleModel`**
    ...
    *   **GitHub Link:**
        *   [`predict_xy` method](https://github.com/scikit-image/skimage/blob/main/src/skimage/measure/fit.py#L683)
...
*   **`EllipseModel`**
    ...
    *   **GitHub Link:**
        *   [`predict_xy` method](https://github.com/scikit-image/skimage/blob/main/src/skimage/measure/fit.py#L984)